    ...
    <div class="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
        <div class="px-6 py-5 border-b border-slate-100">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    <h2 class="text-xl font-semibold text-slate-900">Επιλογή Υποψηφίων Δ.Σ.</h2>
                    <p class="text-sm text-slate-500 mt-1">Ολοκλήρωσε τη λίστα υποψηφίων για το Διοικητικό Συμβούλιο.</p>
                </div>
        ...
        <div class="px-6 py-4 border-b border-slate-100 bg-slate-50">
            <div class="flex items-center gap-2 text-xs font-semibold text-slate-600">
                <span class="px-2 py-1 rounded-full bg-slate-900 text-white">Βήμα 2</span>
                <span>Επιλογή υποψηφίων Δ.Σ.</span>
            </div>
        </div>
