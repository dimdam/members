                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-2 md:space-x-3">
                        ...
                        <button onclick="location.href='{{ url()->previous() }}'"
                            ...
                            Επιστροφή στην Αρχική Σελίδα </button>
                        ...
                        {{-- <div class="ml-3 text-sm leading-5">
                            ...
                            {{-- <button wire:click.prevent="viewSelection()" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded"> Συνέχεια </button> --}}
                        {{-- </div>  --}}

                    </div>
                </div>
                <h2 class="text-center pt-4 font-bold underline"> ΕΠΙΛΟΓΗ ΥΠΟΨΗΦΙΩΝ ΓΙΑ ΕΦΟΡΕΥΤΙΚΗ ΕΠΙΤΡΟΠΗ</h2>

                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg mt-4 table-fixed">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 ">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 py-4 text-left whitespace-no-wrap  border-gray-500 text-sm leading-5">
