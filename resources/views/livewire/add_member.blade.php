    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center px-4 py-8">
        ...
        <div class="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl border border-slate-100">
            <div class="px-6 py-5 border-b border-slate-100">
                <h3 class="text-lg font-semibold text-slate-900">Προσθήκη Νέου Μέλους</h3>
                <p class="text-sm text-slate-500 mt-1">Συμπλήρωσε τα βασικά στοιχεία.</p>
            </div>
            ...
            <form class="px-6 py-5 space-y-4">
                <div>
                    ...
                    <input type="text"
                        ...
                        id="name" placeholder="Εισάγετε εδώ το ονοματεπώνυμο" wire:model="name">
                ...
                <div>
                    ...
                    <input type="tel"
                        class="mt-2 w-full rounded-xl border border-slate-200 px-4 py-2.5 text-slate-900 focus:border-slate-700 focus:ring-2 focus:ring-slate-200"
                        id="phone_number" placeholder="Εισάγετε εδώ τον αριθμό κινητού τηλεφώνου" wire:model="phone_number">
